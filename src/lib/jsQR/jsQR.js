...
!(function (o, e) {
  ...
  (t.m = r = [
    ...
    function (o, e, r) {
      ...
      var t =
        ((c.prototype.multiply = function (o, e) {
          return 0 === o || 0 === e
            ? 0
            : this.expTable[
    ...
    function (o, e, r) {
      ...
      e.binarize = function (o, e, r, t) {
        if (o.length !== e * r * 4)
          throw new Error('Malformed data passed to binarizer.');
        for (var c = new z(e, r), s = 0; s < e; s++)
          for (var a = 0; a < r; a++) {
            var d = o[4 * (a * e + s) + 0],
              n = o[4 * (a * e + s) + 1],
              l = o[4 * (a * e + s) + 2];
            c.set(s, a, 0.2126 * d + 0.7152 * n + 0.0722 * l);
          }
        for (
          var i = Math.ceil(e / 8),
            B = Math.ceil(r / 8),
          ...
          for (var C = 0; C < i; C++) {
            ...
            for (a = 0; a < 8; a++)
              for (s = 0; s < 8; s++) {
                var P = c.get(8 * C + s, 8 * u + a);
                (m += P), (f = Math.min(f, P)), (w = Math.max(w, P));
              }
        ...
        var p = I.BitMatrix.createEmpty(e, r),
          b = null;
        for (t && (b = I.BitMatrix.createEmpty(e, r)), u = 0; u < B; u++)
          for (C = 0; C < i; C++) {
            for (
              var y = O(C, 2, i - 3), g = O(u, 2, B - 3), x = ((m = 0), -2);
              x <= 2;
              x++
            )
              for (var M = -2; M <= 2; M++) m += k.get(y + x, g + M);
            var L = m / 25;
            for (x = 0; x < 8; x++)
              for (M = 0; M < 8; M++) {
                (s = 8 * C + x), (a = 8 * u + M);
                var N = c.get(s, a);
                p.set(s, a, N <= L), t && b.set(s, a, !(N <= L));
              }
          }
        return t ? { binarized: p, inverted: b } : { binarized: p };
      };
    },
    function (o, e, r) {
      'use strict';
      ...
      function c(o) {
        var e = (function (o) {
          var e = o.height,
            r = Math.floor((e - 17) / 4);
          if (r <= 6) return C.VERSIONS[r - 1];
          for (var t = 0, c = 5; 0 <= c; c--)
            for (var s = e - 9; e - 11 <= s; s--) t = w(o.get(s, c), t);
          var a = 0;
          for (s = 5; 0 <= s; s--)
            for (c = e - 9; e - 11 <= c; c--) a = w(o.get(s, c), a);
          for (var d, n = 1 / 0, l = 0, i = C.VERSIONS; l < i.length; l++) {
            var B = i[l];
            if (B.infoBits === t || B.infoBits === a) return B;
            var k = m(t, B.infoBits);
            k < n && ((d = B), (n = k)),
              (k = m(a, B.infoBits)) < n && ((d = B), (n = k));
          }
          return n <= 3 ? d : void 0;
        })(o);
        if (!e) return null;
        var r = (function (o) {
          for (var e = 0, r = 0; r <= 8; r++)
            6 !== r && (e = w(o.get(r, 8), e));
          for (var t = 7; 0 <= t; t--) 6 !== t && (e = w(o.get(8, t), e));
          var c = o.height,
            s = 0;
          for (t = c - 1; c - 7 <= t; t--) s = w(o.get(8, t), s);
          for (r = c - 8; r < c; r++) s = w(o.get(r, 8), s);
          for (var a = 1 / 0, d = null, n = 0, l = P; n < l.length; n++) {
            var i = l[n],
              B = i.bits,
              k = i.formatInfo;
            if (B === e || B === s) return k;
        ...
        var t = (function (o, e, r) {
          ...
          for (var a = t.ecBlocks[0].dataCodewordsPerBlock, d = 0; d < a; d++)
            for (var n = 0, l = c; n < l.length; n++) {
              l[n].codewords.push(o.shift());
            }
          if (1 < t.ecBlocks.length) {
          ...
          return c;
        })(h(o, e, r), e, r.errorCorrectionLevel);
        if (!t) return null;
        for (
        ...
        try {
          return k.decode(s, e.versionNumber);
        } catch (o) {
          return null;
        }
      }
    ...
    function (o, e, r) {
      ...
      function w(o, e) {
        for (
          var r = [], t = '', c = [10, 12, 14][e], s = o.readBits(c);
          3 <= s;

        ) {
          if (1e3 <= (l = o.readBits(10)))
        ...
        if (2 === s) {
          if (100 <= (l = o.readBits(7)))
            throw new Error('Invalid numeric value above 99');
          (a = Math.floor(l / 10)), (d = l % 10);
          r.push(48 + a, 48 + d), (t += a.toString() + d.toString());
        } else if (1 === s) {
          var l;
          if (10 <= (l = o.readBits(4)))
            throw new Error('Invalid numeric value above 9');
          r.push(48 + l), (t += l.toString());
        }
        return { bytes: r, text: t };
      }
      ((t = C = e.Mode || (e.Mode = {})).Numeric = 'numeric'),
        (t.Alphanumeric = 'alphanumeric'),
        (t.Byte = 'byte'),
        (t.Kanji = 'kanji'),
        (t.ECI = 'eci'),
        ((c = m = m || {})[(c.Terminator = 0)] = 'Terminator'),
        (c[(c.Numeric = 1)] = 'Numeric'),
        (c[(c.Alphanumeric = 2)] = 'Alphanumeric'),
        (c[(c.Byte = 4)] = 'Byte'),
        (c[(c.Kanji = 8)] = 'Kanji'),
        (c[(c.ECI = 7)] = 'ECI');
      var i = [
      ...
      function P(o, e) {
        for (
          var r = [], t = '', c = [9, 11, 13][e], s = o.readBits(c);
          2 <= s;
          ...
          var a = o.readBits(11),
            d = Math.floor(a / 45),
            n = a % 45;
          r.push(i[d].charCodeAt(0), i[n].charCodeAt(0)),
            (t += i[d] + i[n]),
            (s -= 2);
        }
        if (1 === s) {
          d = o.readBits(6);
          r.push(i[d].charCodeAt(0)), (t += i[d]);
        }
        return { bytes: r, text: t };
      }
      function v(o, e) {
        for (
          var r = [], t = '', c = [8, 16, 16][e], s = o.readBits(c), a = 0;
          a < s;
          a++
        ) {
          var d = o.readBits(8);
      ...
      function h(o, e) {
        for (
          var r = [], t = '', c = [8, 10, 12][e], s = o.readBits(c), a = 0;
          a < s;
          a++
        ) {
          var d = o.readBits(13),
            n = (Math.floor(d / 192) << 8) | d % 192;
          (n += n < 7936 ? 33088 : 49472),
            r.push(n >> 8, 255 & n),
            (t += String.fromCharCode(l.shiftJISTable[n]));
        }
        return { bytes: r, text: t };
      }
      e.decode = function (o, e) {
        for (
          ...
          if (l === m.ECI)
            ...
            var i = w(a, d);
            (n.text += i.text),
              (r = n.bytes).push.apply(r, i.bytes),
              n.chunks.push({ type: C.Numeric, text: i.text });
          } else if (l === m.Alphanumeric) {
            var B = P(a, d);
            (n.text += B.text),
              (t = n.bytes).push.apply(t, B.bytes),
              n.chunks.push({ type: C.Alphanumeric, text: B.text });
          } else if (l === m.Byte) {
            var k = v(a, d);
            (n.text += k.text),
              (c = n.bytes).push.apply(c, k.bytes),
              n.chunks.push({ type: C.Byte, bytes: k.bytes, text: k.text });
          } else if (l === m.Kanji) {
            var u = h(a, d);
            (n.text += u.text),
              (s = n.bytes).push.apply(s, u.bytes),
              n.chunks.push({ type: C.Kanji, bytes: u.bytes, text: u.text });
          }
        }
      };
    },
    function (o, e, r) {
      ...
      Object.defineProperty(e, '__esModule', { value: !0 });
      var t =
        ((c.prototype.readBits = function (o) {
          if (o < 1 || 32 < o || o > this.available())
    ...
    function (o, e, r) {
      ...
      e.decode = function (o, e) {
        ...
        for (
          ...
          var n = c.evaluateAt(t.exp(d + t.generatorBase));
          0 !== (s[s.length - 1 - d] = n) && (a = !0);
        }
        if (!a) return r;
        var l = new f.default(t, s),
          i = (function (o, e, r, t) {
            e.degree() < r.degree() && ((e = (f = [r, e])[0]), (r = f[1]));
            for (
              var c = e, s = r, a = o.zero, d = o.one;
              s.degree() >= t / 2;
        ...
        for (
          ...
          var C = r.length - 1 - t.log(B[u]);
          if (C < 0) return null;
          r[C] = m.addOrSubtractGF(r[C], k[u]);
        }
        return r;
      };
    },
    ...
    function (o, e, r) {
      ...
      e.extract = function (o, e) {
        for (
          ...
          for (var m = 0; m < e.dimension; m++) {
            var f = u(m + 0.5, C + 0.5);
            k.set(m, C, o.get(Math.floor(f.x), Math.floor(f.y)));
          }
        return { matrix: k, mappingFunction: u };
      };
    },
    function (o, e, r) {
      'use strict';
      ...
      function i(o, e, r, t) {
        var c,
          ...
          a,
          d,
          n = [{ x: Math.floor(o.x), y: Math.floor(o.y) }],
          l = Math.abs(e.y - o.y) > Math.abs(e.x - o.x);
        d = l
          ? ((c = Math.floor(o.y)),
            (s = Math.floor(o.x)),
            (a = Math.floor(e.y)),
        ...
        for (
          ...
          if (
            r.get(P, v) !== m &&
            ((m = !m), n.push({ x: P, y: v }), n.length === t + 1)
          )
            break;
          if (0 < (k += B)) {
            if (w === d) break;
        ...
        for (var h = [], p = 0; p < t; p++)
          n[p] && n[p + 1] ? h.push(E(n[p], n[p + 1])) : h.push(0);
        return h;
      }
      function _(o, e, r, t) {
        var c,
          s = e.y - o.y,
          a = e.x - o.x,
          d = i(o, e, r, Math.ceil(t / 2)),
          n = i(o, { x: o.x - a, y: o.y - s }, r, Math.ceil(t / 2)),
          l = d.shift() + n.shift() - 1;
        return (c = n.concat(l)).concat.apply(c, d);
      }
      function u(r, o) {
        var t = j(r) / j(o),
          c = 0;
        return (
          o.forEach(function (o, e) {
            c += Math.pow(r[e] - o * t, 2);
          }),
          { averageSize: t, error: c }
        );
      }
      function R(o, e, r) {
        try {
          var t = _(o, { x: -1, y: o.y }, r, e.length),
      ...
      e.locate = function (f) {
        ...
        var c = r
          ...
          .map(function (e, r, o) {
            ...
            var c = e.score + t[0].score + t[1].score;
            return { points: [e].concat(t.slice(0, 2)), score: c };
          })
          .filter(function (o) {
            return !!o;
          })
        ...
        try {
          (p = (L = (function (o, e, r, t) {
            ...
            var s = Math.round(E(o, e) / c),
              a = Math.round(E(o, r) / c),
              d = Math.floor((s + a) / 2) + 7;
            switch (d % 4) {
              case 0:
                d++;
                break;
            ...
            return { dimension: d, moduleSize: c };
          })(x, g, M, f)).dimension),
            (b = L.moduleSize);
        } catch (o) {
          return null;
        ...
        var L,
          ...
          A = 15 <= O && X.length ? X[0] : S;
        return {
          alignmentPattern: { x: A.x, y: A.y },
